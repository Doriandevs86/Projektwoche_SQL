...
from src.util.dropdown_funktionen import get_genres_from_db
from src.util.dropdown_funktionen import get_interpreten_from_db
from src.util.dropdown_funktionen import get_rating_from_db
